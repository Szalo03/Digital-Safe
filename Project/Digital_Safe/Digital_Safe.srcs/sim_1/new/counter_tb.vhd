...
begin
    -- 2. Instantiate the Counter (The "Device Under Test")
    ...
    begin
        ...
        -- Test Increment (Move Left)
        s_en_inc <= '1'; wait for CLK_PERIOD; s_en_inc <= '0';
        wait for 20 ns;
        s_en_inc <= '1'; wait for CLK_PERIOD; s_en_inc <= '0';
        wait for 20 ns;

        -- Test Decrement (Move Right)

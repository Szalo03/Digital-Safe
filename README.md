...
[![Watch the video](https://github.com/Szalo03/Digital-Safe/blob/main/Images/video.mp4)
...
### ⚙️[Debounce](<Digital_Safe/Digital_Safe.srcs/sources_1/new/debounce.vhd>) ([Testbench](<TestBenches/debounce_tb>)) 
...
### 🔢 [Counter](<Digital_Safe/Digital_Safe.srcs/sources_1/new/counter.vhd>) ([Testbench](<TestBenches/counter_tb>)) 
...
### 💾 [Register](<Digital_Safe/Digital_Safe.srcs/sources_1/new/Registr.vhd>) ([Testbench](<TestBenches/registr_tb>)) 
...
### ⚖️ [Comparator](<Digital_Safe/Digital_Safe.srcs/sources_1/new/Comparator.vhd>) ([Testbench](<TestBenches/comparator_tb>))  
...
### 📺 [Display Driver](<Digital_Safe/Digital_Safe.srcs/sources_1/new/display_driver.vhd>) ([Testbench](<TestBenches/display_driver_tb>))  
